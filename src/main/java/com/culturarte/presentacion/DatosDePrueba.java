...
public class DatosDePrueba {
    ...
    public void crearDatosPrueba() {
        ...
        Proponente pro = new Proponente(dtoPP.getNick(), dtoPP.getNombre(), dtoPP.getApellido(), dtoPP.getCorreo(), dtoPP.getFechaNac(), dtoPP.getDirImagen(), dtoPP.getDireccion(), dtoPP.getBiografia(), dtoPP.getLink());
        ...
        Proponente pro2 = new Proponente(dtoPP2.getNick(), dtoPP2.getNombre(), dtoPP2.getApellido(), dtoPP2.getCorreo(), dtoPP2.getFechaNac(), dtoPP2.getDirImagen(), dtoPP2.getDireccion(), dtoPP2.getBiografia(), dtoPP2.getLink());
        ...
        Proponente pro3 = new Proponente(dtoPP3.getNick(), dtoPP3.getNombre(), dtoPP3.getApellido(), dtoPP3.getCorreo(), dtoPP3.getFechaNac(), dtoPP3.getDirImagen(), dtoPP3.getDireccion(), dtoPP3.getBiografia(), dtoPP3.getLink());
        ...
        Proponente pro4 = new Proponente(dtoPP4.getNick(), dtoPP4.getNombre(), dtoPP4.getApellido(), dtoPP4.getCorreo(), dtoPP4.getFechaNac(), dtoPP4.getDirImagen(), dtoPP4.getDireccion(), dtoPP4.getBiografia(), dtoPP4.getLink());
        ...
        Proponente pro5 = new Proponente(dtoPP5.getNick(), dtoPP5.getNombre(), dtoPP5.getApellido(), dtoPP5.getCorreo(), dtoPP5.getFechaNac(), dtoPP5.getDirImagen(), dtoPP5.getDireccion(), dtoPP5.getBiografia(), dtoPP5.getLink());
        ...
        Proponente pro6 = new Proponente(dtoPP6.getNick(), dtoPP6.getNombre(), dtoPP6.getApellido(), dtoPP6.getCorreo(), dtoPP6.getFechaNac(), dtoPP6.getDirImagen(), dtoPP6.getDireccion(), dtoPP6.getBiografia(), dtoPP6.getLink());
        ...
        Proponente pro7 = new Proponente(dtoPP7.getNick(), dtoPP7.getNombre(), dtoPP7.getApellido(), dtoPP7.getCorreo(), dtoPP7.getFechaNac(), dtoPP7.getDirImagen(), dtoPP7.getDireccion(), dtoPP7.getBiografia(), dtoPP7.getLink());
        ...
        Proponente pro8 = new Proponente(dtoPP8.getNick(), dtoPP8.getNombre(), dtoPP8.getApellido(), dtoPP8.getCorreo(), dtoPP8.getFechaNac(), dtoPP8.getDirImagen(), dtoPP8.getDireccion(), dtoPP8.getBiografia(), dtoPP8.getLink());
        ...
        Proponente pro9 = new Proponente(dtoPP9.getNick(), dtoPP9.getNombre(), dtoPP9.getApellido(), dtoPP9.getCorreo(), dtoPP9.getFechaNac(), dtoPP9.getDirImagen(), dtoPP9.getDireccion(), dtoPP9.getBiografia(), dtoPP9.getLink());
        ...
        Colaborador col = new Colaborador(CC.getNick(), CC.getNombre(), CC.getApellido(), CC.getCorreo(), CC.getFechaNac(), CC.getDirImagen());
        ...
        Colaborador col2 = new Colaborador(CC2.getNick(), CC2.getNombre(), CC2.getApellido(), CC2.getCorreo(), CC2.getFechaNac(), CC2.getDirImagen());
        ...
        Colaborador col3 = new Colaborador(CC3.getNick(), CC3.getNombre(), CC3.getApellido(), CC3.getCorreo(), CC3.getFechaNac(), CC3.getDirImagen());
        ...
        Colaborador col4 = new Colaborador(CC4.getNick(), CC4.getNombre(), CC4.getApellido(), CC4.getCorreo(), CC4.getFechaNac(), CC4.getDirImagen());
        ...
        Colaborador col5 = new Colaborador(CC5.getNick(), CC5.getNombre(), CC5.getApellido(), CC5.getCorreo(), CC5.getFechaNac(), CC5.getDirImagen());
        ...
        Colaborador col6 = new Colaborador(CC6.getNick(), CC6.getNombre(), CC6.getApellido(), CC6.getCorreo(), CC6.getFechaNac(), CC6.getDirImagen());
        ...
        Colaborador col7 = new Colaborador(CC7.getNick(), CC7.getNombre(), CC7.getApellido(), CC7.getCorreo(), CC7.getFechaNac(), CC7.getDirImagen());
        ...
        Colaborador col8 = new Colaborador(CC8.getNick(), CC8.getNombre(), CC8.getApellido(), CC8.getCorreo(), CC8.getFechaNac(), CC8.getDirImagen());
        ...
        Colaborador col9 = new Colaborador(CC9.getNick(), CC9.getNombre(), CC9.getApellido(), CC9.getCorreo(), CC9.getFechaNac(), CC9.getDirImagen());
        ...
        Colaborador col10 = new Colaborador(CC10.getNick(), CC10.getNombre(), CC10.getApellido(), CC10.getCorreo(), CC10.getFechaNac(), CC10.getDirImagen());
        ...
        Colaborador col11 = new Colaborador(CC11.getNick(), CC11.getNombre(), CC11.getApellido(), CC11.getCorreo(), CC11.getFechaNac(), CC11.getDirImagen());
